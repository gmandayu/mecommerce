...
public partial class mecommerce {
    ...
    /// usersDelete
    /// </summary>
    public static UsersDelete usersDelete
    {
        get => HttpData.Get<UsersDelete>("usersDelete")!;
        set => HttpData["usersDelete"] = value;
    }

    /// <summary>
    /// Page class for Users
    /// </summary>
    public class UsersDelete : UsersDeleteBase
    {
        // Constructor
        public UsersDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public UsersDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class UsersDeleteBase : Users
    {
        // Page ID
        ...
        // Page name
        public string PageName => "usersdelete";
        ...
        // Constructor
        public UsersDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("userslist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("userslist"); // Return to list
                }
            }
