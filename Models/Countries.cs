...
public partial class mecommerce {
    ...
    {
        get => HttpData.Resolve<Countries>("Countries");
        set => HttpData["Countries"] = value;
    }

    /// <summary>
    /// Table class for Countries
    /// </summary>
    public class Countries : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> CountryID;

        public readonly DbField<SqlDbType> ISO;

        public readonly DbField<SqlDbType> _Name;

        public readonly DbField<SqlDbType> NiceName;

        public readonly DbField<SqlDbType> ISO3;

        public readonly DbField<SqlDbType> NumCode;

        public readonly DbField<SqlDbType> PhoneCode;
        ...
        public Countries()
        {
            ...
            Name = "Countries";
            Type = "TABLE";
            UpdateTable = "dbo.Countries"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // CountryID
            CountryID = new (this, "x_CountryID", 3, SqlDbType.Int) {
                Name = "CountryID",
                Expression = "[CountryID]",
                BasicSearchExpression = "CAST([CountryID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[CountryID]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("Countries", "CountryID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("CountryID", CountryID);

            // ISO
            ISO = new (this, "x_ISO", 129, SqlDbType.Char) {
                Name = "ISO",
                Expression = "[ISO]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ISO]",
                DateTimeFormat = -1,
                VirtualExpression = "[ISO]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("Countries", "ISO", "CustomMsg"),
                IsUpload = false
            };
            ISO.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>(ISO, "Countries", true, "ISO", new List<string> {"ISO", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>(ISO, "Countries", true, "ISO", new List<string> {"ISO", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(ISO, "Countries", true, "ISO", new List<string> {"ISO", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("ISO", ISO);
            ...
            _Name = new (this, "x__Name", 200, SqlDbType.VarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("Countries", "_Name", "CustomMsg"),
                IsUpload = false
            };
            _Name.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>(_Name, "Countries", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>(_Name, "Countries", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(_Name, "Countries", true, "Name", new List<string> {"Name", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Name", _Name);

            // NiceName
            NiceName = new (this, "x_NiceName", 200, SqlDbType.VarChar) {
                Name = "NiceName",
                Expression = "[NiceName]",
                UseBasicSearch = true,
                BasicSearchExpression = "[NiceName]",
                DateTimeFormat = -1,
                VirtualExpression = "[NiceName]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("Countries", "NiceName", "CustomMsg"),
                IsUpload = false
            };
            NiceName.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>(NiceName, "Countries", true, "NiceName", new List<string> {"NiceName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>(NiceName, "Countries", true, "NiceName", new List<string> {"NiceName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(NiceName, "Countries", true, "NiceName", new List<string> {"NiceName", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("NiceName", NiceName);

            // ISO3
            ISO3 = new (this, "x_ISO3", 129, SqlDbType.Char) {
                Name = "ISO3",
                Expression = "[ISO3]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ISO3]",
                DateTimeFormat = -1,
                VirtualExpression = "[ISO3]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("Countries", "ISO3", "CustomMsg"),
                IsUpload = false
            };
            ISO3.Lookup = CurrentLanguage switch {
                "en-US" => new Lookup<DbField>(ISO3, "Countries", true, "ISO3", new List<string> {"ISO3", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "id-ID" => new Lookup<DbField>(ISO3, "Countries", true, "ISO3", new List<string> {"ISO3", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(ISO3, "Countries", true, "ISO3", new List<string> {"ISO3", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("ISO3", ISO3);

            // NumCode
            NumCode = new (this, "x_NumCode", 2, SqlDbType.SmallInt) {
                Name = "NumCode",
                Expression = "[NumCode]",
                BasicSearchExpression = "CAST([NumCode] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[NumCode]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("Countries", "NumCode", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("NumCode", NumCode);

            // PhoneCode
            PhoneCode = new (this, "x_PhoneCode", 3, SqlDbType.Int) {
                Name = "PhoneCode",
                Expression = "[PhoneCode]",
                BasicSearchExpression = "CAST([PhoneCode] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[PhoneCode]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("Countries", "PhoneCode", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("PhoneCode", PhoneCode);
            ...
            CreatedBy = new (this, "x_CreatedBy", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Countries", "CreatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            CreatedDateTime = new (this, "x_CreatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Countries", "CreatedDateTime", "CustomMsg"),
                IsUpload = false
            };
            ...
            UpdatedBy = new (this, "x_UpdatedBy", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Countries", "UpdatedBy", "CustomMsg"),
                IsUpload = false
            };
            ...
            UpdatedDateTime = new (this, "x_UpdatedDateTime", 146, SqlDbType.DateTimeOffset) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(1)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Countries", "UpdatedDateTime", "CustomMsg"),
                IsUpload = false
            };
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            try {
                ...
                CountryID.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                CountryID.DbValue = row["CountryID"]; // Set DB value only
                ISO.DbValue = row["ISO"]; // Set DB value only
                _Name.DbValue = row["Name"]; // Set DB value only
                NiceName.DbValue = row["NiceName"]; // Set DB value only
                ISO3.DbValue = row["ISO3"]; // Set DB value only
                NumCode.DbValue = row["NumCode"]; // Set DB value only
                PhoneCode.DbValue = row["PhoneCode"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[CountryID] = @CountryID@";
        ...
        public string GetRecordFilter(Dictionary<string, object>? row = null, bool current = false)
        {
            ...
            val = row?.TryGetValue("CountryID", out result) ?? false
                ? result
                : !Empty(CountryID.OldValue) && !current ? CountryID.OldValue : CountryID.CurrentValue;
            if (!IsNumeric(val))
                return "0=1"; // Invalid key
            if (val == null)
                return "0=1"; // Invalid key
            keyFilter = keyFilter.Replace("@CountryID@", AdjustSql(val, DbId)); // Replace key value
            return keyFilter;
        }
        ...
        public Dictionary<string, object>? GetRowFilterAsDictionary(IDictionary<string, object>? row = null)
        {
            ...
            val = row?.TryGetValue("CountryID", out result) ?? false
                ? result
                : !Empty(CountryID.OldValue) ? CountryID.OldValue : CountryID.CurrentValue;
            if (!IsNumeric(val))
                return null; // Invalid key
            if (Empty(val))
                return null; // Invalid key
            keyFilter.Add("CountryID", val); // Add key value
        ...
        {
            if (SameString(pageName, "countriesview"))
                return Language.Phrase("View");
            else if (SameString(pageName, "countriesedit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "countriesadd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CountriesView",
                Config.ApiAddAction => "CountriesAdd",
                Config.ApiEditAction => "CountriesEdit",
                Config.ApiDeleteAction => "CountriesDelete",
                Config.ApiListAction => "CountriesList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "countrieslist";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("countriesview", parm);
            else
                url = KeyUrl("countriesview", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "countriesadd";
        ...
        {
            string url = "";
            url = KeyUrl("countriesedit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("countrieslist", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("countriesadd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("countrieslist", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("countriesdelete", parm)); // DN
        }
        ...
        {
            string json = "";
            json += "\"CountryID\":" + ConvertToJson(CountryID.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        public string KeyUrl(string url, string parm = "") { // DN
            if (!IsNull(CountryID.CurrentValue)) {
                url += "/" + CountryID.CurrentValue;
            } else {
        ...
        public string GetKey(bool current = false)
        {
            ...
            string val;
            val = current ? ConvertToString(CountryID.CurrentValue) ?? "" : ConvertToString(CountryID.OldValue) ?? "";
            if (Empty(val))
                return String.Empty;
            keys.Add(val);
        ...
        public string GetKey(IDictionary<string, object> row)
        {
            List<string> keys = new ();
            object? val = null, result;
            val = row?.TryGetValue("CountryID", out result) ?? false ? ConvertToString(result) : null;
            if (Empty(val))
        ...
        public void SetKey(string key, bool current = false)
        {
            ...
            if (keys.Length == 1) {
                if (current) {
                    CountryID.CurrentValue = keys[0];
                } else {
                    CountryID.OldValue = keys[0];
                }
            }
        }
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("CountryID", out object? v0)) { // CountryID // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    CountryID.CurrentValue = keys;
                else
                    CountryID.OldValue = keys;
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            CountryID.SetDbValue(dr["CountryID"]);
            ISO.SetDbValue(dr["ISO"]);
            _Name.SetDbValue(dr["Name"]);
            NiceName.SetDbValue(dr["NiceName"]);
            ISO3.SetDbValue(dr["ISO3"]);
            NumCode.SetDbValue(dr["NumCode"]);
            PhoneCode.SetDbValue(dr["PhoneCode"]);
        ...
        public async Task RenderEditRow()
        {
            ...
            // CountryID
            CountryID.SetupEditAttributes();
            CountryID.EditValue = CountryID.CurrentValue;
            CountryID.ViewCustomAttributes = "";
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(ISO);
                        doc.ExportCaption(_Name);
                        doc.ExportCaption(NiceName);
                        doc.ExportCaption(ISO3);
                        doc.ExportCaption(NumCode);
                        doc.ExportCaption(PhoneCode);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(ISO);
                            await doc.ExportField(_Name);
                            await doc.ExportField(NiceName);
                            await doc.ExportField(ISO3);
                            await doc.ExportField(NumCode);
                            await doc.ExportField(PhoneCode);
