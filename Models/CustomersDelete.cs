...
public partial class mecommerce {
    ...
    /// customersDelete
    /// </summary>
    public static CustomersDelete customersDelete
    {
        get => HttpData.Get<CustomersDelete>("customersDelete")!;
        set => HttpData["customersDelete"] = value;
    }

    /// <summary>
    /// Page class for Customers
    /// </summary>
    public class CustomersDelete : CustomersDeleteBase
    {
        // Constructor
        public CustomersDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CustomersDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CustomersDeleteBase : Customers
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "customersDelete";
        ...
        // Page name
        public string PageName => "customersdelete";
        ...
        // Constructor
        public CustomersDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("customerslist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("customerslist"); // Return to list
                }
            }
