...
public partial class mecommerce {
    ...
    /// countriesView
    /// </summary>
    public static CountriesView countriesView
    {
        get => HttpData.Get<CountriesView>("countriesView")!;
        set => HttpData["countriesView"] = value;
    }

    /// <summary>
    /// Page class for Countries
    /// </summary>
    public class CountriesView : CountriesViewBase
    {
        // Constructor
        public CountriesView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CountriesView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CountriesViewBase : Countries
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "countriesView";
        ...
        public CountriesViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["CountryID"] = keys[0];
            } else {
                RecordKeys["CountryID"] = RouteValues.TryGetValue("CountryID", out obj) && obj != null ? UrlDecode(obj) : Get("CountryID"); // DN
            }
        ...
        // Page name
        public string PageName => "countriesview";
        ...
        // Constructor
        public CountriesViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("CountryID", out v) && !Empty(v)) { // DN
                CountryID.QueryValue = UrlDecode(v); // DN
                RecordKeys["CountryID"] = CountryID.QueryValue;
            } else if (Get("CountryID", out sv)) {
                CountryID.QueryValue = sv.ToString();
                RecordKeys["CountryID"] = CountryID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                CountryID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["CountryID"] = CountryID.QueryValue;
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fCountriesview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
