...
public partial class mecommerce {
    ...
    /// subscriptionsDelete
    /// </summary>
    public static SubscriptionsDelete subscriptionsDelete
    {
        get => HttpData.Get<SubscriptionsDelete>("subscriptionsDelete")!;
        set => HttpData["subscriptionsDelete"] = value;
    }

    /// <summary>
    /// Page class for Subscriptions
    /// </summary>
    public class SubscriptionsDelete : SubscriptionsDeleteBase
    {
        // Constructor
        public SubscriptionsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubscriptionsDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubscriptionsDeleteBase : Subscriptions
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subscriptionsDelete";
        ...
        // Constructor
        public SubscriptionsDeleteBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "subscriptionsdelete";
        ...
        // Constructor
        public SubscriptionsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("subscriptionslist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("subscriptionslist"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                subscriptionsDelete?.PageRender();
            }
            return PageResult();
        }
