...
public partial class mecommerce {
    ...
    public static partial class Config
    {
        ...
        public const string ProjectClassName = "ASPNETMaker2023.Models.mecommerce"; // DN
        ...
        public const string ProjectName = "mecommerce"; // Project name
        ...
        public static string RandomKey = "xNtmD0ckPx0HWAaS"; // Random key for encryption

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/mecommerce.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        public static string BodyClass = "hold-transition sidebar-collapse"; // CSS class(es) for <body> tag
        ...
        public static string NavbarClass = "main-header navbar navbar-expand navbar-green navbar-dark"; // CSS class(es) for navbar
        ...
        // Export Log
        public static string ExportPath = "export-0aa1f10e-58ab-481a-991c-e9f0ff4ed711"; // Export folder
        ...
        public static string PushServerPublicKey = "BK5c4XjJMWlBwizZVwV3Agwc-YHPjnQi6pgv65XiBlyRb5LHcwI_LjNPJFkOV6NO5Z6TYwqS7ma6ujkD9n_RuEE"; // Public Key

        public static string PushServerPrivateKey = "1TytY2Y5tUYqzvrRfjTDACfig6RZRl8541umUB3F_D8"; // Private Key
        // Subscription table for Push Notification
        public static string SubscriptionDbId = "DB"; // Subscription DB ID

        public static string SubscriptionTable = "dbo.Subscriptions"; // Subscription table

        public static string SubscriptionTableName = "Subscriptions"; // Subscription table name

        public static string SubscriptionTableVar = "Subscriptions"; // Subscription table var

        public static string SubscriptionFieldNameId = "Id"; // Subscription Id field name

        public static string SubscriptionFieldNameUser = "User"; // Subscription User field name

        public static string SubscriptionFieldNameEndpoint = "Endpoint"; // Subscription Endpoint field name

        public static string SubscriptionFieldNamePublicKey = "PublicKey"; // Subscription Public Key field name

        public static string SubscriptionFieldNameAuthToken = "AuthenticationToken"; // Subscription Auth Token field name

        public static string SubscriptionFieldNameContentEncoding = "ContentEncoding"; // Subscription Content Encoding field name
        ...
        public static string AdminPassword = "admin"; // Administrator password
        ...
        public static bool PasswordHash { get; set; } = true; // Use BCrypt.Net-Next password hashing functions
        ...
        public static string UserProfileFieldName = "ProfileDescription";

        public static string RegisterActivateFieldName = "IsActive";

        public static string UserEmailFieldName = "Email";

        public static string UserPhoneFieldName = "MobileNumber";

        public static string UserImageFieldName = "ProfilePicture";
        ...
        public static string UserIdFilter = "([UserID] = %u)";
        ...
        public static string SenderEmail = "gmandayu@gmail.com"; // Sender email

        public static string RecipientEmail = "gmandayu@gmail.com"; // Recipient email
        ...
        public static string UploadDestPath = "uploads/"; // Upload destination path
        ...
        public static bool UseAjaxActions = true;
        ...
        // Audit trail
        public static string AuditTrailPath = "audit_trails/"; // Audit trail path (relative to wwwroot)
        ...
        {
            new object[] { 21, "mi_Customers", "21", "customerslist", -1, "", "{0AA1F10E-58AB-481A-991C-E9F0FF4ED711}Customers", false, false, "", "", false, true },
            new object[] { 13, "mci_Master", "13", "", -1, "", false, false, true, "", "", false, true },
            new object[] { 17, "mi_Countries", "17", "countrieslist", 13, "", "{0AA1F10E-58AB-481A-991C-E9F0FF4ED711}Countries", false, false, "", "", false, true },
            new object[] { 5, "mci_User_Management", "5", "", -1, "", false, false, true, "", "", false, true },
            new object[] { 18, "mi_Users", "18", "userslist", 5, "", "{0AA1F10E-58AB-481A-991C-E9F0FF4ED711}Users", false, false, "", "", false, true },
            new object[] { 16, "mi_UserLevels", "16", "userlevelslist", 5, "", "{0AA1F10E-58AB-481A-991C-E9F0FF4ED711}UserLevels", false, false, "", "", false, true },
            new object[] { 15, "mi_UserLevelPermissions", "15", "userlevelpermissionslist", 5, "", "{0AA1F10E-58AB-481A-991C-E9F0FF4ED711}UserLevelPermissions", false, false, "", "", false, true },
            new object[] { 19, "mi_AuditTrail", "19", "audittraillist", -1, "", "{0AA1F10E-58AB-481A-991C-E9F0FF4ED711}AuditTrail", false, false, "", "", false, true },
            new object[] { 20, "mi_Subscriptions", "20", "subscriptionslist", -1, "", "{0AA1F10E-58AB-481A-991C-E9F0FF4ED711}Subscriptions", false, false, "", "", false, true }
        };
