...
public partial class mecommerce {
    ...
    /// subscriptionsView
    /// </summary>
    public static SubscriptionsView subscriptionsView
    {
        get => HttpData.Get<SubscriptionsView>("subscriptionsView")!;
        set => HttpData["subscriptionsView"] = value;
    }

    /// <summary>
    /// Page class for Subscriptions
    /// </summary>
    public class SubscriptionsView : SubscriptionsViewBase
    {
        // Constructor
        public SubscriptionsView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public SubscriptionsView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class SubscriptionsViewBase : Subscriptions
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "subscriptionsView";
        ...
        // Page name
        public string PageName => "subscriptionsview";
        ...
        // Constructor
        public SubscriptionsViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fSubscriptionsview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
