                ...
                if (IsShow) {
                    if (!IsModal) { // Normal edit page
                        ...
                        if (TotalRecords <= 0) { // No record found
                            ...
                            if (UserLevelID.CurrentValue != null && _TableName.CurrentValue != null) {
                                while (Recordset != null && await Recordset.ReadAsync()) {
                                    if (SameString(UserLevelID.CurrentValue, Recordset["UserLevelID"]) && SameString(_TableName.CurrentValue, Recordset["TableName"])) {
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                if (!Empty(Permission.EditValue) && IsNumeric(Permission.EditValue))
                    Permission.EditValue = FormatNumber(Permission.EditValue, Permission.FormatPattern);
