...
public partial class mecommerce {
    ...
    {
        get => HttpData.Resolve<Subscriptions>("Subscriptions");
        set => HttpData["Subscriptions"] = value;
    }

    /// <summary>
    /// Table class for Subscriptions
    /// </summary>
    public class Subscriptions : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Endpoint;

        public readonly DbField<SqlDbType> PublicKey;

        public readonly DbField<SqlDbType> AuthenticationToken;

        public readonly DbField<SqlDbType> ContentEncoding;
        ...
        public Subscriptions()
        {
            ...
            Name = "Subscriptions";
            Type = "TABLE";
            UpdateTable = "dbo.Subscriptions"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            _User = new (this, "x__User", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Subscriptions", "_User", "CustomMsg"),
                IsUpload = false
            };
            ...
            Endpoint = new (this, "x_Endpoint", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("Subscriptions", "Endpoint", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Endpoint", Endpoint);

            // PublicKey
            PublicKey = new (this, "x_PublicKey", 202, SqlDbType.NVarChar) {
                Name = "PublicKey",
                Expression = "[PublicKey]",
                UseBasicSearch = true,
                BasicSearchExpression = "[PublicKey]",
                DateTimeFormat = -1,
                VirtualExpression = "[PublicKey]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("Subscriptions", "PublicKey", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("PublicKey", PublicKey);

            // AuthenticationToken
            AuthenticationToken = new (this, "x_AuthenticationToken", 202, SqlDbType.NVarChar) {
                Name = "AuthenticationToken",
                Expression = "[AuthenticationToken]",
                UseBasicSearch = true,
                BasicSearchExpression = "[AuthenticationToken]",
                DateTimeFormat = -1,
                VirtualExpression = "[AuthenticationToken]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("Subscriptions", "AuthenticationToken", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("AuthenticationToken", AuthenticationToken);

            // ContentEncoding
            ContentEncoding = new (this, "x_ContentEncoding", 202, SqlDbType.NVarChar) {
                Name = "ContentEncoding",
                Expression = "[ContentEncoding]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ContentEncoding]",
                DateTimeFormat = -1,
                VirtualExpression = "[ContentEncoding]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("Subscriptions", "ContentEncoding", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ContentEncoding", ContentEncoding);
        ...
        {
            get => _sqlFrom ?? "dbo.Subscriptions";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Endpoint.DbValue = row["Endpoint"]; // Set DB value only
                PublicKey.DbValue = row["PublicKey"]; // Set DB value only
                AuthenticationToken.DbValue = row["AuthenticationToken"]; // Set DB value only
                ContentEncoding.DbValue = row["ContentEncoding"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "subscriptionsview"))
                return Language.Phrase("View");
            else if (SameString(pageName, "subscriptionsedit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "subscriptionsadd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "SubscriptionsView",
                Config.ApiAddAction => "SubscriptionsAdd",
                Config.ApiEditAction => "SubscriptionsEdit",
                Config.ApiDeleteAction => "SubscriptionsDelete",
                Config.ApiListAction => "SubscriptionsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "subscriptionslist";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("subscriptionsview", parm);
            else
                url = KeyUrl("subscriptionsview", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "subscriptionsadd";
        ...
        {
            string url = "";
            url = KeyUrl("subscriptionsedit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("subscriptionslist", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("subscriptionsadd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("subscriptionslist", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("subscriptionsdelete", parm)); // DN
        }
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            Endpoint.SetDbValue(dr["Endpoint"]);
            PublicKey.SetDbValue(dr["PublicKey"]);
            AuthenticationToken.SetDbValue(dr["AuthenticationToken"]);
            ContentEncoding.SetDbValue(dr["ContentEncoding"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "SubscriptionsList";
