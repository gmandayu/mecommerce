...
public partial class mecommerce {
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(mecommerce).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(mecommerce).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
    ...
    public static string GetRgbaColor(string color, double? opacity = null)
    {
        ...
        return "rgba(" + String.Join(",", rgb) + "," + opacity.Value.ToString(CultureInfo.CreateSpecificCulture("en-US")) + ")";
    }
    ...
    // User Table
    public static Users UserTable
    {
        get => HttpData.Get<Users>("USER_TABLE")!;
