...
public partial class mecommerce {
    ...
    /// auditTrailDelete
    /// </summary>
    public static AuditTrailDelete auditTrailDelete
    {
        get => HttpData.Get<AuditTrailDelete>("auditTrailDelete")!;
        set => HttpData["auditTrailDelete"] = value;
    }

    /// <summary>
    /// Page class for AuditTrail
    /// </summary>
    public class AuditTrailDelete : AuditTrailDeleteBase
    {
        // Constructor
        public AuditTrailDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AuditTrailDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AuditTrailDeleteBase : AuditTrail
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "auditTrailDelete";
        ...
        // Page name
        public string PageName => "audittraildelete";
        ...
        // Constructor
        public AuditTrailDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("audittraillist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("audittraillist"); // Return to list
                }
            }
